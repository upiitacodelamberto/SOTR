...
mov $29,%cx
mov $0x000c,%bx
mov $get_hd_0_data,%bp		# .ascii "Get hd0 data ........"
mov $0x1301,%ax
int $0x10
...
mov $29,%cx
mov $0x000c,%bx
mov $get_hd_1_data,%bp		# .ascii "Get hd1 data ........"
mov $0x1301,%ax
int $0x10
...
mov $29,%cx
mov $0x000c,%bx
mov $we_are_at_no_disk1,%bp 	# .ascii "we are at no_disk1...."
mov $0x1301,%ax
int $0x10
	mov	$INITSEG, %ax
	mov	%ax, %es
...
mov $29,%cx
mov $0x000c,%bx
mov $we_are_moving_to_protected_mode,%bp
mov $0x1301,%ax
int $0x10
...
#2017.09.21 HASTA AQUI LO QUE COPIE DE xv6
...
sect:
	.ascii "Sectors:"
we_are_moving_to_protected_mode:
.byte 13,10
.ascii "we are moving to prote"
.byte 13,10,13,10
.text
endtext:
.data
