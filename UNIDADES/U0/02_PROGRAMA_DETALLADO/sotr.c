...
wchar_t Subtema_3_1_1[] = L"Clasificacion de tareas";
wchar_t Tema_3_2[] = L"Interrupciones";
wchar_t Subtema_3_2_1[] = L"Concepto";
wchar_t Subtema_3_2_2[] = L"Clasificacion de las interrupciones";
...
wchar_t Unidad_4[] = L"Planificacion de procesos";
wchar_t Tema_4_1[] = L"Planificador del sistema en tiempo real";
wchar_t Subtema_4_1_1[] = L"Estructura de planificacion";
wchar_t Subtema_4_1_2[] = L"Despachador";
wchar_t Tema_4_2[] = L"Enfoque ciclico";
wchar_t Tema_4_3[] = L"Algoritmos de planificacion";
wchar_t Subtema_4_3_1[] = L"Planificacion apropiativa y no apropiativa";
wchar_t Subtema_4_3_2[] = L"Planificacion por prioridad";
wchar_t Subtema_4_3_3[] = L"Evaluacion de los algoritmos";
wchar_t Tema_4_4[] = L"Procesos esporadicos y aperiodicos";
