...
//	panic("mem_init: This function is not finished\n");
	...
	// Your code goes here: LAB 2 ANSWER.
	...
	// LAB 3: Your code here.//ANSWER Exercise 1_1 _1
	...
	// Your code goes here: LAB 2 ANSWER (PART 3).
	...
	// LAB 3: Your code here.//ANSWER Exercise 1_1 _2
	...
	// Your code goes here: LAB 2 ANSWER (PART 3).
// This gets commented out because all kernel stacks get mapped per CPU   (*LAB4 Exercise 2*)
// in mem_init_mp()
...
mem_init_mp(void)
{
	...
	//     Permissions: kernel RW, user NONE
	//
	// LAB 4: Your code here: ANSWER   Exercise 3
	uint32_t i;
...
page_init(void)
{
	...
	//  2) Mark a physical page in use if it does not appear in
	//     e820_map or if its type is not "available" (type 1).
	...
	for (i = 0; i < npages; i++) {
	  if (i==0|| // First page reserved for BIOS structures
	            i==PGNUM(MPENTRY_PADDR)|| // 7th page at MPENTRY_PADDR, reserved for CPU startup code
...
page_free(struct PageInfo *pp)
{
	...
	// pp->pp_link is not NULL. LAB 2 ANSWER.
  	assert(pp->pp_ref == 0);
...
{
	// Fill this function in //LAB 2 ANSWER
	pte_t *pte;
...
mmio_map_region(physaddr_t pa, size_t size)
{
	...
	//
	// Your code here:      ANSWER Lab4 Exercise 1
	size_t roundupsize=ROUNDUP(size,PGSIZE);
	if(base+roundupsize>MMIOLIM)
	  panic("mmio_map_region: requested size to mapwent over MMIOLIM");
	boot_map_region(kern_pgdir,base,roundupsize,pa,PTE_PCD|PTE_PWT|PTE_W);
